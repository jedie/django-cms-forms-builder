...
__version__="<unknown>"
exec(read('cms_forms_builder', 'version.py'))
...
setup(
    name='django-cms-forms-builder',
    version=__version__,
    description="Ready to use Django CMS plugin for django-forms-builder.",
    long_description=long_description,
    author='Jens Diemer',
    author_email='django-cms-forms-builder@jensdiemer.de',
    url='https://github.com/jedie/django-cms-forms-builder',
    packages=[
        'cms_forms_builder',
        'cms_forms_builder_test_project',
        'cms_forms_builder_tests',
    ],
    include_package_data=True,
    license="GNU GPL v3 or above",
    zip_safe=False,
    keywords='django cms django-cms forms forms-builder',
    python_requires='>=3.5',
    install_requires=[
        "django",
        "django-cms",

        # see also: cms_forms_builder/requirements.txt
